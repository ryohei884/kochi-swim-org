...
const meet: meetType[] = [
  ...
  {
    kind: 1,
    fromDate: new Date("2025/06/07"),
    toDate: new Date("2025/06/08"),
  ...
  {
    kind: 1,
    fromDate: new Date("2025/07/22"),
    toDate: new Date("2025/07/23"),
    title: "高知県中学校水泳競技大会",
    place: "くろしおアリーナ",
    poolsize: 2,
    result: false,
  ...
  {
    kind: 1,
    fromDate: new Date("2025/07/26"),
    toDate: new Date("2025/07/27"),
    title: "高知県選手権水泳競技大会",
    place: "くろしおアリーナ",
    poolsize: 2,
    result: false,
  ...
  {
    kind: 1,
    fromDate: new Date("2025/08/06"),
    toDate: new Date("2025/08/08"),
      ...
      for (let i = 0; i < meet.length; i++) {
        await prisma.meet.create({
          data: {
            kind: meet[i].kind,
            title: meet[i].title,
            fromDate: meet[i].fromDate,
            toDate: meet[i].toDate !== null ? meet[i].toDate : null,
            place: meet[i].place,

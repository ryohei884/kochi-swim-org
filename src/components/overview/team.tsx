    ...
    committees: [
      {
        ...
        name: "副会長",
        head: "清水 雅明",
        description: "普及委員, 情報システム委員, 高知SC（競泳）担当",
        contact: "",
      },
      {
        id: 3,
        name: "副会長",
        head: "寺尾 緑",
        description: "アーティスティックスイミング委員長, 高知SC（AS）担当",
        contact: "",
      },
      {
        id: 4,
        name: "理事長",
        head: "堤 知之",
        description: "競技委員長, オープンウォータースイミング委員長",
        contact: "",
      },
      {
        id: 5,
        ...
        head: "和田 英晃",
        description:
          "生涯水泳委員長, 競技委員, 競技力強化委員, オープンウォータースイミング委員, スイミングクラブ担当",
        contact: "",
      },
      {
        id: 6,
        name: "副理事長",
        head: "北村 和代",
        description: "総務委員長, 競技委員, 障害者スポーツ担当",
        contact: "",
      },
      {
        id: 7,
      ...
      },
      {
        ...
        name: "常任理事",
        head: "小谷 直美",
        description: "会計委員長, 普及委員, 高知SC（水球）担当",
        contact: "",
      },
      {
        id: 9,
      ...
      },
      {
        ...
        head: "竹村 和洋",
        description:
          "事務局長, 競技委員, オープンウォータースイミング委員, 中体連担当",
        contact: "",
      },
      {
        id: 11,
        name: "常任理事",
        head: "徳田 毅",
        description: "水球委員長, 競技委員, 競技力強化委員",
        contact: "",
      },
      {
        id: 12,
        name: "常任理事",
        head: "西岡 伸朗",
        description: "情報システム委員長, 競技委員, 高体連担当",
        contact: "",
      },
      {
        id: 13,
      ...
      },
      {
        ...
        name: "常任理事",
        head: "瓶子 勇治郎",
        description: "飛込委員長, 競技委員, 競技力強化委員",
        contact: "",
      },
      {
        id: 15,

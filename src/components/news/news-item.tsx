            ...
            {!news ? (
              ...
              >
                <Link
                  href={
                    "/" +
                    (newsLinkCategory.find((v) => v.id === news.linkCategory)
                      ?.href || "") +
                ...
                >
                  <div className="relative min-w-full lg:min-w-sm aspect-3/2">
                    <Image
                      ...
                      className="min-w-full h-auto lg:min-w-sm rounded-2xl bg-gray-100 object-cover aspect-3/2 dark:bg-gray-800"
                    />
